        ...
        {state.basket.length > 0 && (
          <div className="favorite_linkBar">
            <div className="free_send_title">
              ...
              <span>
                Shipping cost for high purchases 100,000 Toman is free.
              </span>
            </div>
          </div>
        )}
        ...
        <div className="basket_container">
          ...
          <div className="basket_priceBox">
            ...
            <div className="basket_price">
              ...
              <span>|</span>
              <span>{state.totalPrice.toLocaleString()} Toman</span>
            </div>
            {state.totalPriceAfterOffer > 0 && (
              <div className="basket_offer">
                <span>Discounted price</span>
                <span>{state.totalPriceAfterOffer.toLocaleString()} Toman</span>
              </div>
            )}
            <Offer />
            <SendProducts />
            <div className="basket_send">
              ...
              <span>{state.totalPriceFainal.toLocaleString()} Toman</span>
            </div>
